...
/*!
  ...
  @param[in,out] A      The known system matrix, also contains the MG hierarchy in attributes Ac and mgData.
  @param[in,out] data   The data structure with all necessary CG vectors preallocated
  @param[in,out] b      The known right hand side vector
  @param[in,out] x      The solution vector to be computed in future CG iteration
  @param[in,out] xexact The exact solution vector
