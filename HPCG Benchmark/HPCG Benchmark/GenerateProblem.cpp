...
/*!
  ...
  @param[in,out] b      The newly allocated and generated right hand side vector (if b!=0 on entry)
  @param[in,out] x      The newly allocated solution vector with entries set to 0.0 (if x!=0 on entry)
  @param[in,out] xexact The newly allocated solution vector with entries set to the exact solution (if the xexact!=0 non-zero on entry)
